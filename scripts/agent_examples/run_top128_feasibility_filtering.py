...
SMITH_PACKAGE_ROOT = Path(os.environ.get("SMITH_PACKAGE_ROOT", str(PROJECT_ROOT)))
HUMAN_REFERENCE_DIR = Path(os.environ.get("SMITH_HUMAN_REFERENCE_DIR", str(SMITH_PACKAGE_ROOT / "third_party/reference_data/probedealer_human_full")))
